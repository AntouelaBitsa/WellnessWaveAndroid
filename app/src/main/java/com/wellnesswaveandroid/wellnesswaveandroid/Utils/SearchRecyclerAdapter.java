...
import com.wellnesswaveandroid.wellnesswaveandroid.Activities.DiagnosisRecordsActivity;
...
public class SearchRecyclerAdapter extends RecyclerView.Adapter<SearchRecyclerAdapter.SearchViewHolder> {
    ...
    public SearchRecyclerAdapter(Context context, List<Patient> patientList, OnItemClickListener onItemClickListener) {
...
//    }
    ...
    public SearchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.search_bar_item, parent, false);
